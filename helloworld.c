...
static void __pyx_f_10helloworld_say_hello(PyObject *__pyx_v_name) {
 ...
 */
  ...
  __Pyx_WriteUnraisable("helloworld.say_hello", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_L0:;
